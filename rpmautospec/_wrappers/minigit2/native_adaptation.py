...
FUNC_DECLS = {
    ...
    "git_reference_list": (c_int, (git_strarray_p, git_repository_p)),
    ...
    "git_reference_create": (
        c_int,
        (git_reference_p_p, git_repository_p, c_char_p, git_oid_p, c_int, c_char_p),
    ),
    "git_reference_symbolic_target": (c_char_p, (git_reference_p,)),
    "git_strarray_free": (None, (git_strarray_p,)),
