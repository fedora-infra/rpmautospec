...
FUNC_DECLS = {
    ...
    "git_branch_create": (
        c_int, (git_reference_p_p, git_repository_p, c_char_p, git_commit_p, c_int)
    ),
    ...
    "git_index_add_all": (
        c_int, (git_index_p, git_strarray_p, c_uint, git_index_matched_path_cb, c_void_p)
    ),
    ...
    "git_index_write_tree": (c_int, (git_oid_p, git_index_p,)),
    ...
    "git_repository_init_ext": (
        c_int, (git_repository_p_p, c_char_p, git_repository_init_options_p)
    ),
